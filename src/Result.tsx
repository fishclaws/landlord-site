        ...
        <div className={scrolled ? 'right right-up' : 'right right-down'} onScroll={handleScroll} ref={rightRef}>
          ...
          <div className='data-container'>
            ...
            <div className='join-wrapper'>
              {
                !showSurvey && showJoin && <Join text={"Signup to get connected with neighbors who also review this landlord/property and to join Renters Action Network to fight for cheaper rent"} property_id={result.property ? result.property.property_id : undefined} />
              }
            </div>
